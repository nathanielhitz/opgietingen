...
- Elke post komt meerdere keren voor in de ruwe output (één keer per Message-type); dedupliceert op het `id`-veld van de post-metadata en behoudt alleen items met een niet-lege `caption`.
